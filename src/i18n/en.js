...
· Finding a signal does not fix the estimate. The copula is a diagnostic; the remedy is at the design level — add the omitted variable, find an instrument, or use a method that handles simultaneity.`,
    ...
    apa: {
      ...
      predAll: 'indicating out-of-sample predictive power that exceeds the benchmark.',
      predSome: 'indicating that out-of-sample predictive power exceeds the benchmark for some indicators only.',
      predNone: 'indicating no out-of-sample predictive power beyond the benchmark.',
