...
1. **R 的部分**：雙擊 `跑抽驗腳本.bat`
   ...
   ★ **另有第二波（2026-07-30 / A5b 收尾新增）：雙擊 `跑R抽驗.bat`** → 跑 `05_a5b_r_audit.R`，
   對象是**非 PLS 側**的 CFA／EFA／ANOVA／Tukey／KW 效果量／A5b 六支的慣例，
   輸出 `out\05_a5b_r_audit_out.txt`。兩支互相獨立，先跑哪一支都可以。
