...
2. ✅ **已於 2026-07-30 在 Kevin 本機與 R `ptukey()` 對照**（R 4.6.0，
   `scripts/validation/05_a5b_r_audit.R` §4）。R 的 `ptukey` 是獨立的 Fortran 實作，
   ★ **含 R50 的失準區在內全數通過**：

   | $q$ | $k$ | df | R 上尾 | 本工具 | 相對差 |
   |---|---|---|---|---|---|
   | 3.5 | 3 | 57 | 0.04251789049 | 0.042517890501 | 1.6e−10 |
   | 3.5 | 3 | **120** | 0.03883337495 | 0.038833375015 | 1.7e−09 |
   | 4.5 | 3 | **999** | 0.00429911236 | 0.004299112528 | 3.9e−08 |
   | 3.5 | 4 | **100** | 0.07012160478 | 0.070121604983 | 2.8e−09 |
   | 1.7 | 10 | 200 | 0.97132442136 | 0.971324421530 | 1.8e−10 |

   `TukeyHSD()` 的三對比較亦逐值相符（0.4583200／0.0067007／0.1271912）。
   ⇒ **`ptukey.js:18` 那句註解終於有證據支持**，且 R50 的修正經第三方確認
